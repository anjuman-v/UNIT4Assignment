...
module.exports = async (req, res, next)=>{
    ...
    //if not then throw an error 400 of Bad req
    ...
    if(!bearerToken.startsWith("Bearer ")) return res.status(400).send({message: "Please provide a valid authorization token"});
